...
export default (): JSX.Element => {
  return (
    <React.Fragment>
      ...
      <Section>
        <Paragraph>
          The website {addLinkTo("http://demo.iov.one")}  (hereinafter: the “Website”) is owned and operated by the company IOV
      ...
      <Section>
        ...
        <Paragraph>
          ...
          a transfer of title, and, subject to mandatory legal provisions, you may not:
          </Paragraph>
        <Block padding="sm" margin="sm">
          <Paragraph> - modify or copy the
            materials;</Paragraph>
          <Paragraph> - use the materials for any commercial purpose, or for any public display (commercial or
            non-commercial);</Paragraph>
          <Paragraph> - attempt to decompile or reverse engineer any software contained on the Website;</Paragraph>
          <Paragraph> - remove any copyright or other proprietary information from the materials; or</Paragraph>
          <Paragraph> - transfer the materials
            to another person or "mirror" the materials on any other server.</Paragraph>
        </Block>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          Further, IOV does not warrant or make any
