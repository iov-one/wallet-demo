  ...
  return (
    <React.Fragment>
      ...
      <Section>
        ...
        <Block padding="sm" margin="sm">
          <Paragraph strong inline> - Access to your information</Paragraph>
          <Paragraph inline>
            &nbsp;– You have the right to request a copy of your personal information that we hold.
          </Paragraph>
          <Block />
          <Paragraph strong inline> - Correcting your information</Paragraph>
          <Paragraph inline>
          ...
          <Block />
          <Paragraph strong inline> - Deletion of your information</Paragraph>
          <Paragraph inline>
          ...
          <Block />
          <Paragraph strong inline> - Oppose or restrict how we may use your information</Paragraph>
          <Paragraph inline>
          ...
          <Block />
          <Paragraph strong inline> - Opt-out to the reception of newsletters.</Paragraph>
          <Paragraph inline>
            &nbsp;You may at any time decide to opt-out to the reception of our newsletters.
          </Paragraph>
          <Block />
          <Paragraph strong inline> - SectionParagraphRight to data portability</Paragraph>
          <Paragraph inline>
