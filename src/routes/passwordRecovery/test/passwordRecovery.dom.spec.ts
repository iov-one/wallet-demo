...
import { getRandomMnemonic, getRealMnemonic, PasswordFormData, processProfileRecovery, processUpdatePass, travelToProfileRecovery, travelToUpdatePass } from "./util/travelPassRecovery";
...
describe("DOM > Feature > Password Recovery", () => {
  ...
  describe("Second step", () => {
    ...
    it(
      "submit should be disabled if input fields are empty",
      async () => {
        const UpdatePassDom = await travelToUpdatePass(refreshStore);
    ...
    it(
      "submit should be disabled if input fields values are not equal",
      async () => {
    ...
    it(
      "submit should be enabled if input fields values are equal",
      async () => {
