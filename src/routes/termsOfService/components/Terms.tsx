...
const PageTerms = ({ classes }: Props) => (
  <React.Fragment>
    ...
    <Block margin="xl" maxWidth={450} className={classes.content}>
      ...
      <Block padding="xl">
        <Typography weight="light" variant="body2">
          The website http://demo.iov.one  (hereinafter: the “Website”) is owned and operated by the company
          IOV SAS, 55 Rue La Boetie, 75008, Paris, France (hereinafter "IOV").
          <Block margin="lg" />
          By accessing the Website , you are agreeing to be bound by these terms of service, all applicable
    ...
    <Block margin="xl" maxWidth={450} className={classes.content}>
      <Block margin="xxl" />
      <Block padding="xl">
        <Typography weight="light" variant="body2" paragraph={true}>
          ...
          contained on the Website; • remove any copyright or other proprietary information from the
          materials; or • transfer the materials to another person or "mirror" the materials on any other
          server.
          <Block margin="lg" />
    ...
    <Block margin="xl" maxWidth={450} className={classes.content}>
      ...
      <Block padding="xl">
        <Typography weight="light" variant="body2">
          ...
          unauthorized person using your account.
          <Block margin="lg" />
          OV may disable you Member account or password, whether chosen by you or allocated by us, at any
    ...
    <Block margin="xl" maxWidth={450} className={classes.content}>
      ...
      <Block padding="xl">
        <Typography weight="light" variant="body2">
          ...
          representative has been notified orally or in writing of the possibility of such damage. The
          foregoing disclaimer of certain damages and limitation of liability will apply to the maximum extent
          permitted by applicable law. The laws of some states or jurisdictions do not allow the exclusion or
          limitation of certain damages, so some or all of the exclusions and limitations set forth above may
          not apply to you.
        </Typography>
      </Block>
      <Block margin="xxl" />
    ...
    <Block margin="xl" maxWidth={450} className={classes.content}>
      ...
      <Block padding="xl">
        <Typography weight="light" variant="body2">
          For any request, please contact us at contact@iov.one
        </Typography>
      </Block>
      <Block margin="xxl" />
    </Block>
